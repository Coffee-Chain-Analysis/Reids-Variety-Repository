...
```{r dnkn_sbux, echo = FALSE, message = FALSE}
dnkn_sbux <- tibble(
  longitude = c(dnknloc %>%
...
```{r store_per_state_dunkin_2, echo = FALSE, message = FALSE}
df<-df %>% 
  mutate(ZIP=as.numeric(ZIP))
...
```{r store_per_state_starbucks_7, echo = FALSE, message = FALSE}
#---------------------------------------------------------------------------------------------------------------------------
# by county
...
```{r revenue_starbucks_2, message = FALSE, warning = FALSE}
 starbuck_rev %>% 
   ...
   theme(plot.title = element_text(hjust = 0.5)) + xlab("Year") + ylab("Revenue")  +  facet_wrap(~Type, nrow = 3, scales = "free")
```

```{r revenue_starbucks_3, message = FALSE, echo = FALSE, warning = FALSE}
# starbuck_rev %>%
# group_by(Type) %>%
...
```{r revenue_starbucks_5, message = FALSE, echo = FALSE, warning = FALSE}
...
```{r revenue_dunkin, message = FALSE, echo = FALSE, warning = FALSE}
...
```{r revenue_dunkin_2, message = FALSE, echo = FALSE, warning = FALSE}
dunk_rev<- read_csv("data/dunkin.csv")
